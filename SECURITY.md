...
1. Email **security@opensauria.ai** with a detailed description of the vulnerability.
...
OpenSauria is built with a security-first architecture:
...
- **No remote telemetry**: OpenSauria does not phone home or collect usage data.
